...
ВОПРОС ПРЕПОДАВАТЕЛЮ:
    При просмотре отчета покрытия тестов в браузере конечные ссылки с функциями не кликабельны - т.е. код с подсветкой
    не могу увидеть. Соответственно не вижу какие ветки закрыты тестами, какие - не до конца, а какие вовсе не затронуты.
    Помогите, пожалуйста. Решение (верно ли?) - затёр ссылки на пакеты...
 */
fun main() {
